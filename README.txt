Proyecto: recursos editables para crear subtítulos para personas sordas
...
Dirección de correo electrónico: a@m.com
Pass: admin2024
...
y creé un proyecto desde cero con la template que terminé eligiendo, así que no debería verse nada de eso.
2. El LogoutView no funciona 
3. Cuando puse git add., me salió el siguiente WARNING. Aviso porque no sé si afectará cómo se ve mi página en otros dispositivos.
